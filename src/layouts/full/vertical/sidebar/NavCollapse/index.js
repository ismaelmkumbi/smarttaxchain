...
// mui imports
import { ListItemIcon, ListItem, Collapse, styled, ListItemText, useTheme, Box } from '@mui/material';
  ...
  return (
    <React.Fragment key={menu.id}>
      ...
      >
        ...
        >
          {!open ? (
            <IconChevronDown size="1rem" color="currentColor" />
          ) : (
            <IconChevronUp size="1rem" color="currentColor" />
          )}
        </Box>
      </ListItemStyled>
